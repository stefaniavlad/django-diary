...
class DistributionPath(object):
    ...
    def get_exported_entries(self, category, name=None):
        """
        Return all of the exported diaryapp in a particular category.

        :param category: The category to search for diaryapp.
        :param name: If specified, only diaryapp with that name are returned.
        """
        for dist in self.get_distributions():
            r = dist.exports
            if category in r:
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def _get_records(self):
        ...
        :return: A list of tuples of path, hash and size. Note that hash and
                 size might be ``None`` for some diaryapp. The path is exactly
    ...
    def exports(self):
        ...
        :return: A dictionary of exports, mapping an export category to a dict
                 ...
                 export diaryapp, and keyed by name.
        """
        result = {}
    ...
    def list_installed_files(self):
        """
        Iterates over the ``RECORD`` diaryapp and returns a tuple
    ...
    def list_distinfo_files(self):
        """
        Iterates over the ``RECORD`` diaryapp and returns paths for each line if
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    def list_installed_files(self):
        """
        Iterates over the ``installed-files.txt`` diaryapp and returns a tuple
        ``(path, hash, size)`` for each line.
    ...
    def list_distinfo_files(self, absolute=False):
        """
        Iterates over the ``installed-files.txt`` diaryapp and returns paths for
